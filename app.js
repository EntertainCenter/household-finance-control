...
async function loadSummary() {
  ...
  document.getElementById(
    ...
    money(
      data.current_weekly_spending_target
    );
  ...
  document.getElementById(
    ...
    money(
      data.projected_monthly_surplus
    );
  ...
  document.getElementById(
    ...
    money(
      data.maximum_weekly_spending_before_surplus
    );
  ...
  document.getElementById(
    ...
    money(
      data.bills_account_above_floor
    );
  ...
  document
    .getElementById("accountsSection")
    .classList
    .remove("hidden");
...
startApp();async function checkLogin() {
